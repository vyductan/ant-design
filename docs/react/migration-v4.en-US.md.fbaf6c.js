...
);`]],["h4","Component refactoring"],["ul",["li",["p","Form rewrite."],["ul",["li",["p","No need to use ",["code","Form.create"],"."]],["li",["p","Nest fields definition changes from ",["code","'xxx.yyy'"]," to ",["code","['xxx', 'yyy']"],"."]],["li",["p",["code","validateTrigger"]," no long collect field value."]],["li",["p","See ",["a",{title:null,href:"/components/form/v3"},"here"]," for migration documentation."]]]],["li",["p","DatePicker rewrite"],["ul",["li",["p","Provide the ",["code","picker"]," property for selector switching."]],["li",["p","Range selection can now select start and end times individually."]],["li",["p",["code","onPanelChange"]," will also trigger when panel value changed."]],["li",["p",["a",{title:null,href:"/components/date-picker/#components-date-picker-demo-date-render"},"Date cell className of Custom style demo"]," changed from ",["code","ant-calendar-date"]," to ",["code","ant-picker-cell-inner"],"."]]]],["li",["p","Tree, Select, TreeSelect, AutoComplete rewrite"],["ul",["li",["p","use virtual scrolling."]],["li",["p",["code","onBlur"]," no longer trigger value change and return React origin ",["code","event"]," object instead."],["ul",["li",["p","If config ",["code","validateTrigger"]," as ",["code","onBlur"]," with compatible Form, please change to ",["code","onChange"]," instead."]]]],["li",["p","AutoComplete no longer support ",["code","optionLabelProp"],". Please set Option ",["code","value"]," directly."]],["li",["p","AutoComplete options definition align with Select. Please use ",["code","options"]," instead of ",["code","dataSource"],"."]],["li",["p","Select remove ",["code","dropdownMenuStyle"]," prop."]],["li",["p","Use ",["code","listHeight"]," to config popup height instead of ",["code","dropdownStyle"],"."]],["li",["p",["code","filterOption"]," return origin data with second params instead. No need to use ",["code","option.props.children"]," for matching."]],["li",["p","Tree, TreeSelect will display ",["code","label"]," when ",["code","title"]," and ",["code","label"]," are both set. The adjustment is for aligning behavior with ",["code","labelInValue"],". ",["a",{title:null,href:"https://codesandbox.io/s/keen-curran-d3qnp"},"New behavior"]," (show 'label' on first node). ",["a",{title:null,href:"https://codesandbox.io/s/muddy-darkness-57lb3"},"Old behavior"]," (show 'title' on first node)."]]]],["li",["p","The Grid component uses flex layout."]],["li",["p","Button's ",["code","danger"]," is now treated as a property instead of a button type."]],["li",["p","Input, Select set ",["code","value"]," to ",["code","undefined"]," is uncontrolled mode now."]],["li",["p","Table rewrite."],["ul",["li",["p","will keep at least one column even if ",["code","columns"]," is empty."]],["li",["p","Nest ",["code","dataIndex"]," definition changes from ",["code","'xxx.yyy'"]," to ",["code","['xxx', 'yyy']"],"."]]]],["li",["p","Pagination"],["ul",["li",["p","will default set ",["code","showSizeChanger"]," to ",["code","true"]," since ",["code","4.1.0"],". This change also applied on Table component."]],["li",["p",["code","onChange"]," will also trigger when ",["code","pageSize"]," value changed."]]]],["li",["p","Tabs rewrite. (",["a",{title:null,href:"https://github.com/ant-design/ant-design/pull/24552"},"4.3.0"],")"],["ul",["li",["p","Dom structrue is changed, please check style if you override tabs css."]],["li",["p",["code","onPrevClick"]," \u548C ",["code","onNextClick"]," would be not working anymore since we improve tabs scroll behavior."]]]]],["pre",{lang:"diff",highlighted:`<span class="token deleted">&lt;Table</span>
  columns={[
    {
      title: 'Age',

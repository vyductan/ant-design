...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var k=a(0),A=a(56),p=a(12),n=e(a(0)),r=e(a(4135));function e(g){return g&&g.__esModule?g:{default:g}}var l=function(){return n.default.createElement(p.Alert,{banner:!0,message:n.default.createElement(r.default,{pauseOnHover:!0,gradient:!1},"I can be a React component, multiple React components, or just some text.")})},t=l;return k.createElement(t)}}},4135:function(d,v,a){function w(e){if(!e||typeof window=="undefined")return;const l=document.createElement("style");return l.setAttribute("type","text/css"),l.innerHTML=e,document.head.appendChild(l),e}Object.defineProperty(v,"__esModule",{value:!0});var k=a(0);function A(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var p=A(k);/*! *****************************************************************************
...
}`);var r=function(e){var l,t,g,f,E=e.style,C=E===void 0?{}:E,q=e.className,S=q===void 0?"":q,b=e.play,o=b===void 0?!0:b,i=e.pauseOnHover,s=i===void 0?!1:i,c=e.pauseOnClick,u=c===void 0?!1:c,m=e.direction,y=m===void 0?"left":m,h=e.speed,x=h===void 0?20:h,D=e.delay,I=D===void 0?0:D,M=e.loop,T=M===void 0?0:M,O=e.gradient,Z=O===void 0?!0:O,P=e.gradientColor,R=P===void 0?[255,255,255]:P,F=e.gradientWidth,N=F===void 0?200:F,K=e.onFinish,Q=e.onCycleComplete,j=e.children,H=k.useState(0),V=H[0],Y=H[1],L=k.useState(0),$=L[0],_=L[1],J=k.useState(!1),W=J[0],nn=J[1],z=k.useRef(null),U=k.useRef(null);k.useEffect(function(){if(!!W){var B=function(){U.current&&z.current&&(Y(z.current.getBoundingClientRect().width),_(U.current.getBoundingClientRect().width))};return B(),window.addEventListener("resize",B),function(){window.removeEventListener("resize",B)}}},[W]),k.useEffect(function(){nn(!0)},[]);var X="rgba("+R[0]+", "+R[1]+", "+R[2],G=$<V?V/x:$/x;return p.default.createElement(k.Fragment,null,W?p.default.createElement("div",{ref:z,style:n(n({},C),(l={},l["--pause-on-hover"]=!o||s?"paused":"running",l["--pause-on-click"]=!o||s&&!u||u?"paused":"running",l)),className:S+" marquee-container"},Z&&p.default.createElement("div",{style:(t={},t["--gradient-color"]=X+", 1), "+X+", 0)",t["--gradient-width"]=typeof N=="number"?N+"px":N,t),className:"overlay"}),p.default.createElement("div",{ref:U,style:(g={},g["--play"]=o?"running":"paused",g["--direction"]=y==="left"?"normal":"reverse",g["--duration"]=G+"s",g["--delay"]=I+"s",g["--iteration-count"]=T?""+T:"infinite",g),className:"marquee",onAnimationIteration:Q,onAnimationEnd:K},j),p.default.createElement("div",{style:(f={},f["--play"]=o?"running":"paused",f["--direction"]=y==="left"?"normal":"reverse",f["--duration"]=G+"s",f["--delay"]=I+"s",f["--iteration-count"]=T?""+T:"infinite",f),className:"marquee","aria-hidden":"true"},j)):null)};v.default=r},4136:function(d,v,a){d.exports={content:{"zh-CN":[["p","\u5E73\u6ED1\u3001\u81EA\u7136\u7684\u5378\u8F7D\u63D0\u793A\u3002"]],"en-US":[["p","Smoothly unmount Alert upon close."]]},meta:{order:7,title:{"zh-CN":"\u5E73\u6ED1\u5730\u5378\u8F7D","en-US":"Smoothly Unmount"},filename:"components/alert/demo/smooth-closed.md",id:"components-alert-demo-smooth-closed"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Alert } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
